...
#for 600x1024  768x1024  480x800 ...
COMMON_CCFLAGS=' -DWITH_LCD_LANDSCAPE '
#for 1280x480 480x854 ...
#COMMON_CCFLAGS=' -DWITH_LCD_PORTRAIT '
COMMON_CCFLAGS=COMMON_CCFLAGS+' -DHAS_STD_MALLOC -DHAS_STDIO -DWITH_VGCANVAS -DWITH_UNICODE_BREAK -DLINUX'
...
TSLIB_LIB_DIR=''
TSLIB_INC_DIR=''
TOOLS_PREFIX='/work/allwiner/s3/buildroot-2017.11/output/host/usr/bin/arm-linux-gnueabihf-'
